...
function HollysPage() {
    ...
    useEffect(() => {
        axios.get('http://3.38.119.135:8080/api/drink/list/할리스', {
            headers: {
    ...
    return (
        <div>
            <div className="bkcolor_hollys">
                <div className="bdbox">
                    <div className="logobox">
                        <img src="hollys.png" alt="로고" className="fran_logo" onClick={handleLogoClick} />
                        <div className="bdboxup">할리스</div>
                    </div>
