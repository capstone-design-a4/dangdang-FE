    ...
    <div className="menu_card">
      <div className="menu_image_wrapper">
        ...
        <div className="menu_detail">
          ...
          <span><img src="caffeine.png" alt="카페인 이미지" className="caf_card_img" />{props.caffeine}</span>
          <span><img src="kcal.png" alt="칼로리 이미지" className="kcal_card_img" />{props.calorie}</span>
        </div>
      </div>
