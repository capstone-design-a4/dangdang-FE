...
function BaekPage() {
    ...
    useEffect(() => {
        axios.get('http://3.38.119.135:8080/api/drink/list/빽다방', {
            headers: {
    ...
    const getColor = (condition) => {
        return sortCond === condition ? '#071E61' : 'white';
    }
            ...
            <div className="bkcolor_baek">
                <div className="bdbox">
                    <div className="logobox">
                        <img src="baek.png" alt="로고" className="fran_logo" onClick={handleLogoClick} />
