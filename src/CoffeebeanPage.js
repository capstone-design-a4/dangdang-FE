...
function CoffeebeanPage() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/api/drink/list/커피빈', {
            headers: {
    ...
    const getColor = (condition) => {
        return sortCond === condition ? '#87C4FF' : 'white';
    }
    
    return (
        <div>
            <div className="bkcolor_coffeebean">
                <div className="bdbox">
                    <div className="logobox">
                        <img src="coffeebean.png" alt="로고" className="fran_logo" onClick={handleLogoClick} />
                        <div className="bdboxup">커피빈</div>
                    </div>
