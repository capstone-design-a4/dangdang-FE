...
function GongchaPage() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/api/drink/list/공차', {
            headers: {
                'X-Auth-Username': user.email,
                'X-Auth-Authorities': user.authorities
            }
    ...
    return (
        <div>
            <div className="bkcolor_gongcha">
                <div className="bdbox">
                    <div className="logobox">
                        <img src="gongcha.png" alt="로고" className="gongcha_logo" onClick={handleLogoClick} />
                        <div className="bdboxup">공차</div>
                    </div>
